...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/document-driven-Q43NpW1z.mjs').then((m) => m.default || m)
  }
];
...
const cfg0 = defineAppConfig({
  docus: {
    ...
    socials: {
      twitter: "randommoleculez",
      github: "AntiFragile-AI"
    },
    github: {
      dir: ".starters/default/content",
      branch: "main",
      repo: "docs",
      owner: "AntiFragile-AI",
      edit: true
    },
    aside: {
      level: 0,
...
const inlineConfig = {
  "nuxt": {
    "buildId": "baee9ad1-0576-4ad9-8793-96fdce2c3bf1"
  }
};
...
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./_nuxt/DocumentDrivenNotFound-802zEG8S.mjs').then((r) => r.default));
const LazyEllipsis = defineAsyncComponent(() => import('./_nuxt/Ellipsis-Od5Mw0Th.mjs').then((r) => r.default));
const LazyThemeSelect = defineAsyncComponent(() => Promise.resolve().then(function() {
  return ThemeSelect;
}).then((r) => r.default));
const LazyDocsAside = defineAsyncComponent(() => import('./_nuxt/DocsAside-3A0rHHRk.mjs').then((r) => r.default));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(function() {
  return DocsAsideTree;
}).then((r) => r.default));
const LazyDocsPageBottom = defineAsyncComponent(() => import('./_nuxt/DocsPageBottom-M6_hgYZ6.mjs').then((r) => r.default));
const LazyDocsPageLayout = defineAsyncComponent(() => import('./_nuxt/DocsPageLayout-zodXFbV_.mjs').then((r) => r.default));
const LazyDocsPrevNext = defineAsyncComponent(() => import('./_nuxt/DocsPrevNext-YwGEJHQX.mjs').then((r) => r.default));
const LazyDocsToc = defineAsyncComponent(() => import('./_nuxt/DocsToc-8-PeoafJ.mjs').then((r) => r.default));
const LazyDocsTocLinks = defineAsyncComponent(() => import('./_nuxt/DocsTocLinks-T-eZL6JC.mjs').then((r) => r.default));
const LazyEditOnLink = defineAsyncComponent(() => import('./_nuxt/EditOnLink-Rrshm9pg.mjs').then((r) => r.default));
const LazySourceLink = defineAsyncComponent(() => import('./_nuxt/SourceLink-AQrBRaMW.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-E-oke3bH.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-33xN9Rdp.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./_nuxt/ProseCode--O8OF8sr.mjs').then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-Y-LYO4PU.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-jSdrD7p3.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-kIuLr6MD.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-8FtHe3Fe.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-4tpMyQaK.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-CEbuSCko.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-Tj7Q-S-4.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-v6F-WIm1.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-geAB69DK.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-M_ccjhQM.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-D31pM_eE.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-o0RYzW5h.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-IYgKVObI.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-jd2NXEty.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-PE2uDXBT.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-L-c9t5GZ.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-bjX4pEbw.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-SANVoBHB.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-28vUoPDz.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-VabKSfCE.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-a6SoXNjh.mjs').then((r) => r.default));
const LazyAlert = defineAsyncComponent(() => import('./_nuxt/Alert-2F8eThh5.mjs').then((r) => r.default));
const LazyBadge = defineAsyncComponent(() => import('./_nuxt/Badge-u9rzzRKC.mjs').then((r) => r.default));
const LazyButtonLink = defineAsyncComponent(() => import('./_nuxt/ButtonLink-pewjycWN.mjs').then((r) => r.default));
const LazyCallout = defineAsyncComponent(() => import('./_nuxt/Callout-qbyHmQEU.mjs').then((r) => r.default));
const LazyCodeBlock = defineAsyncComponent(() => import('./_nuxt/CodeBlock-DoGezb_O.mjs').then((r) => r.default));
const LazyCodeGroup = defineAsyncComponent(() => import('./_nuxt/CodeGroup-Aw46fnTz.mjs').then((r) => r.default));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Container;
}).then((r) => r.default));
const LazyCopyButton = defineAsyncComponent(() => import('./_nuxt/CopyButton-Zshxm8-N.mjs').then((r) => r.default));
const LazyList = defineAsyncComponent(() => import('./_nuxt/List-x4wMttK0.mjs').then((r) => r.default));
const LazyNuxtImg = defineAsyncComponent(() => import('./_nuxt/NuxtImg-3w5VSpWV.mjs').then((r) => r.default));
const LazyProps = defineAsyncComponent(() => import('./_nuxt/Props-ju0nmkTe.mjs').then((r) => r.default));
const LazySandbox = defineAsyncComponent(() => import('./_nuxt/Sandbox-zeJJYfKy.mjs').then((r) => r.default));
const LazyTabsHeader = defineAsyncComponent(() => import('./_nuxt/TabsHeader-zhyjw01C.mjs').then((r) => r.default));
const LazyTerminal = defineAsyncComponent(() => import('./_nuxt/Terminal-XNEa6JAw.mjs').then((r) => r.default));
const LazyVideoPlayer = defineAsyncComponent(() => import('./_nuxt/VideoPlayer-x2iBZHrN.mjs').then((r) => r.default));
const LazyIconCodeSandBox = defineAsyncComponent(() => import('./_nuxt/IconCodeSandBox-omlMgwn8.mjs').then((r) => r.default));
const LazyIconDocus = defineAsyncComponent(() => import('./_nuxt/IconDocus-ZOFMy1N7.mjs').then((r) => r.default));
const LazyIconNuxt = defineAsyncComponent(() => import('./_nuxt/IconNuxt-IMGKCQD0.mjs').then((r) => r.default));
const LazyIconNuxtContent = defineAsyncComponent(() => import('./_nuxt/IconNuxtContent-NCpA2Pmh.mjs').then((r) => r.default));
const LazyIconNuxtLabs = defineAsyncComponent(() => import('./_nuxt/IconNuxtLabs-9rUR_Qwo.mjs').then((r) => r.default));
const LazyIconNuxtStudio = defineAsyncComponent(() => import('./_nuxt/IconNuxtStudio-yhmRYPqL.mjs').then((r) => r.default));
const LazyIconStackBlitz = defineAsyncComponent(() => import('./_nuxt/IconStackBlitz-BKr9w7BD.mjs').then((r) => r.default));
const LazyIconVueTelescope = defineAsyncComponent(() => import('./_nuxt/IconVueTelescope-thnd2Vcb.mjs').then((r) => r.default));
const LazyBlockHero = defineAsyncComponent(() => import('./_nuxt/BlockHero-TKXsrdB6.mjs').then((r) => r.default));
const LazyCard = defineAsyncComponent(() => import('./_nuxt/Card-hCQCfmWT.mjs').then((r) => r.default));
const LazyCardGrid = defineAsyncComponent(() => import('./_nuxt/CardGrid-acUBs-yo.mjs').then((r) => r.default));
const LazyVoltaBoard = defineAsyncComponent(() => import('./_nuxt/VoltaBoard-gpnLYzB8.mjs').then((r) => r.default));
const LazyComponentPlayground = defineAsyncComponent(() => import('./_nuxt/ComponentPlayground-GCBr75wc.mjs').then((r) => r.default));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import('./_nuxt/ComponentPlaygroundData-n7Bd5ixB.mjs').then((r) => r.default));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import('./_nuxt/ComponentPlaygroundProps-8zES6IKd.mjs').then((r) => r.default));
...
const LazyPreviewLayout = defineAsyncComponent(() => import('./_nuxt/PreviewLayout-YpUQhIfC.mjs').then((r) => r.default));
const LazyTokensPlayground = defineAsyncComponent(() => import('./_nuxt/TokensPlayground-ALOkTe4-.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-F0p1KIrd.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-RX2aSl1R.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-mRQ2eg1E.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-AjMEK4KX.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-VuhUHC5k.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-F_Ubftm5.mjs').then((r) => r.default));
...
const LazyProsePre = defineAsyncComponent(() => import('./_nuxt/ProsePre-2-v_Oby0.mjs').then((r) => r.default));
...
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-DWLDGzgC.mjs').then((r) => r.default));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./_nuxt/client-db-Q6QAGIbj.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./_nuxt/client-db-Q6QAGIbj.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: () => import('./_nuxt/default-MG7kfpiP.mjs').then((m) => m.default || m),
  page: () => import('./_nuxt/page-zJvbm7Hi.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-XaHVbyAH.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-SpQBn7eY.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-Jzq2F6WS.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useColorMode as A, useVModel as B, usePinceauTheme as C, queryContent as D, fetchContentNavigation as E, get$1 as F, assertArray as G, ensureArray as H, omit as I, sortList as J, apply as K, LayoutMetaSymbol as L, withoutKeys as M, withKeys as N, createQuery as O, PageRouteSymbol as P, _export_sfc as _, __nuxt_component_0$4 as a, useRoute as b, createError as c, appLayoutTransition as d, entry$1 as default, _wrapIf as e, useNuxtApp as f, useRuntimeConfig as g, useContent as h, useRequestEvent as i, useContentHead as j, usePinceauRuntime as k, layouts as l, useContentPreview as m, computedStyle as n, __nuxt_component_0$5 as o, useDocus as p, __nuxt_component_0$3 as q, useAppConfig as r, useState as s, __nuxt_component_0$6 as t, useHead as u, useContentHelpers as v, useRouter as w, useClipboard as x, onClickOutside as y, useAsyncData as z };
